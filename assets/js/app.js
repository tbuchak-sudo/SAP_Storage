const App = {
    ...
    templates: {
        ...
        'tests': `
            <div class="max-w-xl mx-auto bg-white p-8 rounded-3xl shadow-lg border border-slate-100 text-center fade-in">
                ...
                <button class="px-8 py-3 bg-green-600 hover:bg-green-700 text-white font-bold rounded-xl transition shadow-lg">Скласти тест</button>
            </div>
        `,
        'sap/basics': `
    ...
    updateProgressUI() {
        const total = 6; // Всього 6 модулів у новому плані
